...
public class AgreementPop extends MyBaseCenterPop<PopAgreementBinding, BasePresenter> {
    ...
    private void initTag() {
        ...
        style.append("亲爱的用户，感谢您一直以来的支持！\n" +
                "位寻宝一直以来将用户的信息安全与隐私保护视为自己的“生命线”。我们已根据现行法律法规制定了《用户协议》\n" +
                "和《隐私政策》，并且对于重点内容，我们已经描述在协议中。请您仔细阅读\n\n"+"提示您注意：当您点击“我同意并确认”时，" +
        ...
        style.setSpan(serviceClickableSpan, 63, 69, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        style.setSpan(ClickableSpan, 71, 77, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        mBinding.tvContent.setText(style);
        //设置部分文字颜色
//        ForegroundColorSpan serviceColorSpan = new ForegroundColorSpan(Color.parseColor("#55D5BC"));
//        style.setSpan(serviceColorSpan, 66, 72, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
//        ForegroundColorSpan ColorSpan = new ForegroundColorSpan(Color.parseColor("#55D5BC"));
//        style.setSpan(ColorSpan, 73, 82, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
